<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html "
            ...
            <span class="ms-1 font-weight-bold">Rusa Kutub Studio</span>
        </a>
    </div>
    ...
    <div class="ps__rail-y" style="top: 10px; height: 885px; right: 0px;">
        <div class="ps__thumb-y" tabindex="0" style="top: 10px; height: 875px;"></div>
    </div>
</aside>
